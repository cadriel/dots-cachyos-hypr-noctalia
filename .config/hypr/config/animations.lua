...
hl.animation({ leaf = "layersIn",         enabled = true,  speed = 3.6,  bezier = "gracefulFade", style = "slide" })
hl.animation({ leaf = "layersOut",        enabled = true,  speed = 2.4,  bezier = "quickFadeOut" })

hl.animation({ leaf = "fadeLayersIn",     enabled = true,  speed = 2.4,  bezier = "gracefulFade" })
hl.animation({ leaf = "fadeLayersOut",    enabled = true,  speed = 4,    bezier = "quickFadeOut" })
